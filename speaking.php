  ...
  <main>
        ...
        <nav class="js-mega-menu navbar navbar-expand-lg hs-menu-initialized hs-menu-horizontal">
          <div class="container">
            ...
            <div class="d-inline-block g-hidden-md-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg">
              <a class="btn u-btn-outline-primary g-font-size-13 text-uppercase g-py-10 g-px-15" href="index.html" target="_blank">Sign Out</a>
            </div>
          </div>
        </nav>
      </div>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options="{direction: 'reverse', settings_mode_oneelement_max_offset: '150'}">
      ...
      <div class="container g-color-white g-z-index-1 g-py-170">
        <h1 class="display-4 g-font-weight-600 g-letter-spacing-1 g-mb-25">Speaking</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="d-flex g-mb-20">
            ...
            <p class="mb-0">
              <a class="g-color-white-opacity-0_8 g-color-white--hover" href="mailto:info@hstream.com">info@htmlstream.com</a>
              <br>
