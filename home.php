...
<body>
  <main>
        ...
        <nav class="js-mega-menu navbar navbar-expand-lg hs-menu-initialized hs-menu-horizontal">
          <div class="container">
            ...
            <div class="d-inline-block g-hidden-md-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg">
              <a class="btn u-btn-outline-primary g-font-size-13 text-uppercase g-py-10 g-px-15" href="index.php" target="index.php">Sign Out</a>
            </div>
          </div>
        </nav>
      </div>
    ...
    <!-- Promo Block -->
    <section class="g-bg-cover g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after g-min-height-100vh g-flex-centered g-py-100" style="background-image: url(image-49829291-best-free-pc-wallpaper-1920x1080.jpg);">
      <div class="container g-color-white text-center g-z-index-1">
        <div class="mb-5">
          ...
          <p class="g-font-size-24">This is the main home page</p>
        </div>
    ...
    <div class="row no-gutters g-brd-bottom--lg g-brd-gray-light-v4">
      ...
      <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v4 g-pa-60">
        ...
        <div class="text-center">
          ...
          <h3 class="h4 g-color-gray-dark-v2 mb-3">Excellent features</h3>
          <p class="mb-0">We strive to embrace and drive change in our industry which allows us to keep our clients relevant.</p>
        </div>
        <!-- End Icon Blocks -->
      </div>
      ...
      <div class="col-lg-4 g-brd-left--lg g-brd-gray-light-v4 g-pa-60">
        ...
        <div class="text-center">
          ...
          <h3 class="h4 g-color-gray-dark-v2 mb-3">Fully responsive</h3>
          <p class="mb-0">We strive to embrace and drive change in our industry which allows us to keep our clients relevant.</p>
        </div>
        <!-- End Icon Blocks -->
      </div>
    ...
    <section class="g-py-100">
      <div class="container">
        <header class="text-center g-width-60x--md mx-auto g-mb-60">
          ...
          <p class="lead">Recfirm <strong>creates</strong> stunning websites according to your specification.We are Focused on helping our clients to build a <strong>successful</strong> business on web and mobile.</p>
        </header>

        <div class="row">
          <div class="col-lg-6 align-self-center">
            <img class="img-fluid" src="image-49829291-best-free-pc-wallpaper-1920x1080.jpg" alt="Image description">
          </div>

          <div class="col-lg-6 align-self-center g-pl-30--lg g-mb-50 g-mb-0--lg">
            <p class="g-mb-30">Recfirm <strong>Websites</strong>design provides key digital services. Focused on helping our clients to build a <strong>successful</strong> business on web and mobile.</p>

            <div class="row">
              <div class="col-sm-6">
                <ul class="list-unstyled g-color-gray-dark-v4 g-mb-30 g-mb-0--sm">
                  <li class="d-flex g-mb-10">
                    <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i> Based on your ideas
                  </li>
                  <li class="d-flex g-mb-10">
                    <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i> Responsive websites
                  </li>
                  <li class="d-flex g-mb-10">
                    <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i> Semantic HTML5/CSS3 Codes
                  </li>
                  <li class="d-flex g-mb-10">
                    <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i> Great SASS Architecture
                  </li>
                </ul>
              </div>
              ...
              <div class="col-sm-6">
                <ul class="list-unstyled g-color-gray-dark-v4">
                  ...
                  <li class="d-flex g-mb-10">
                    <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i> Many Thematic Examples
                  </li>
                  <li class="d-flex g-mb-10">
                    <i class="icon-arrow-right-circle g-color-primary g-mt-5 g-mr-10"></i> We make Premium Plugins
                  </li>
                </ul>
              </div>
            </div>
    ...
    <section class="g-bg-secondary g-py-100">
      <div class="container">
        <header class="text-center g-width-60x--md mx-auto g-mb-60">
          ...
          <p class="lead">Recfirm <strong>creative</strong> technology company providing key digital services. Focused on helping our clients to build a <strong>successful</strong> business on web and mobile.</p>
        </header>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 g-mb-50 g-mb-0--lg">
            <!-- Testimonials -->
            <blockquote class="lead u-blockquote-v1 rounded g-pl-60 g-pr-30 g-py-30 g-mb-40">I just requested for a web design weeks ago. The Website is really nice and offers quite a large set of options.</blockquote>
            <div class="media">
              ...
              <div class="media-body align-self-center">
                <h4 class="h6 g-color-gray-dark-v2 g-font-weight-600 g-mb-0">David Dut</h4>
          ...
          <div class="col-md-6">
            <!-- Testimonials -->
            <blockquote class="lead u-blockquote-v1 rounded g-pl-60 g-pr-30 g-py-30 g-mb-40">Hi there purchased a couple of days ago and the site looks great, big thanks to the Recfirm guys, they gave me some great help with some fiddly setup issues.</blockquote>
            <div class="media">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
            ...
            <p>About Recfirm dolor sit amet, consectetur adipiscing elit. Maecenas eget nisl id libero tincidunt sodales.</p>
          </div>
          <!-- End Footer Content -->
          ...
          <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
            ...
            <article>
              <h3 class="h6 g-mb-2">
            <a class="g-color-white-opacity-0_8 g-color-white--hover" href="#!">Incredible Design</a>
          </h3>
          ...
          <div class="d-flex g-mb-20">
            ...
            <p class="mb-0">
              <a class="g-color-white-opacity-0_8 g-color-white--hover" href="mailto:info@htmlstream.com">info@stream.com</a>
              <br>
              <a class="g-color-white-opacity-0_8 g-color-white--hover" href="#!">www.stream.com</a>
            </p>
          </div>
