  ...
  <main>
        ...
        <nav class="js-mega-menu navbar navbar-expand-lg hs-menu-initialized hs-menu-horizontal">
          <div class="container">
            ...
            <div class="d-inline-block g-hidden-md-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg">
              <a class="btn u-btn-outline-primary g-font-size-13 text-uppercase g-py-10 g-px-15" href="index.php" target="_blank">Sign Out</a>
            </div>
          </div>
        </nav>
      </div>
    ...
    <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall" data-options='{direction: "fromtop", animation_duration: 25, direction: "reverse"}'>
      ...
      <div class="container g-color-white text-center g-py-150">
        ...
        <h3 class="h1 text-uppercase mb-0">Dr Subiri Website is a fully responsive website</h3>
      </div>
      <!-- Promo Block Content -->
    </section>
    <!-- End Promo Block -->
      ...
      <div class="row justify-content-center g-mb-60">
        <div class="col-lg-7">
          ...
          <div class="text-center">
            <h2 class="h3 g-color-black text-uppercase mb-2">We are Recfirm</h2>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="d-flex g-mb-20">
            ...
            <p class="mb-0">10908 Westlands, <br> woodvale groove, CA 94107 795</p>
          </div>
          <!-- End Location -->
          ...
          <div class="d-flex g-mb-20">
            ...
            <p class="mb-0">(+254) 456 7890 <br> (+254) 456 7891</p>
          </div>
          <!-- End Phone -->
          ...
          <div class="d-flex g-mb-20">
            ...
            <p class="mb-0">
              <a class="g-color-white-opacity-0_8 g-color-white--hover" href="mailto:info@stream.com">info@stream.com</a>
              <br>
